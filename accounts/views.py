...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            mail_subject = 'Your Account on Ravi Readymade has been created!'
...
def dashboard(request):
    ...
    context = {'userprofile': userprofile,'orders_count': orders_count}
...
def order_detail(request, order_id):
    ...
    context = {'order': order, 'order_detail': order_detail,'subtotal':subtotal}
